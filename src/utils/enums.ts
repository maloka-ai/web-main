...
export enum AnalysisSubPages {
  COCKPIT = 'cockpit',
  CUSTOMERS_MORE_OR_LESS_ACTIVE = 'customers_more_or_less_active',
  CUSTOMERS_360 = 'customer_360',
  CUSTOMERS_PROBABILITY_OF_RETURN = 'customers_probability_of_return',
